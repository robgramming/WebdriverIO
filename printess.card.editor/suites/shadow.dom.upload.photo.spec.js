...
describe("Upload photos to the card editor.", async function() {
    it("should expect the photos button", async function() {
        let photosButton = await $('printess-component').shadow$("div.bc-tab-nav div.bc-tab-item");
    ...
    it("should click on the photos button and expect the Upload Images button", async function() {
        ...
        let uploadImages = await $('printess-component').shadow$("input[type=file]");
    ...
    it("should expect upload image thumbnail to exist", async function() {
        let uploadThumbnail = await $('printess-component').shadow$("div.bc-image-thumb-container");
